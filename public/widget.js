"use strict";(()=>{(function(){let c="https://api.rezify.io/api/v1",p=document.currentScript||(function(){let i=document.getElementsByTagName("script");return i[i.length-1]})(),l=p.getAttribute("data-shop")||p.getAttribute("data-tenant-id"),d=p.getAttribute("data-primary-color")||"#3b82f6";if(!l){console.error("Rezify.io Widget: Missing data-shop attribute");return}function b(){let i=localStorage.getItem("REZIFY_session");return i||(i="sid_"+Math.random().toString(36).substr(2,9)+Date.now().toString(36),localStorage.setItem("REZIFY_session",i)),i}let g=b(),e={isValid:!1,minimized:!1,draftsUsed:0,draftsRemaining:10,currentImage:null,currentDesignId:null,productType:"tshirt",prompt:"",loading:!1,gateOpen:!1},s=document.createElement("div");s.id="REZIFY-widget-root",s.style.position="fixed",s.style.bottom="20px",s.style.right="20px",s.style.zIndex="999999",document.body.appendChild(s);let t=s.attachShadow({mode:"open"});function r(){let i=`
    ...
    `;let m=t.getElementById("min-btn");if(m&&(m.onclick=()=>{e.minimized=!0,r()}),e.draftsRemaining<=0&&!e.gateOpen){let o=t.getElementById("lead-submit");o&&(o.onclick=async()=>{let n=t.getElementById("lead-name").value,a=t.getElementById("lead-email").value,f=t.getElementById("lead-phone").value;if(!n||!a)return alert("Name and email are required");o.innerHTML='<div class="spinner"></div>',o.disabled=!0;try{await fetch(`${c}/leads/capture`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:l,session_id:g,name:n,email:a,phone:f})}),e.gateOpen=!0,r()}catch{alert("Error submitting request"),o.innerHTML="Submit Request",o.disabled=!1}});return}if(e.currentImage){let o=t.getElementById("btn-back");o&&(o.onclick=()=>{e.currentImage=null,r()});let n=t.getElementById("btn-save");n&&(n.onclick=async()=>{let a=n.innerHTML;n.innerHTML='<div class="spinner"></div>',n.disabled=!0;try{await fetch(`${c}/generate/save`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:l,session_id:g,design_id:e.currentDesignId})}),e.currentImage=null,e.minimized=!0,alert("Concept saved! Our team will review it.")}catch{alert("Error saving concept")}finally{r()}})}else{let o=t.getElementById("btn-generate");o&&(o.onclick=async()=>{if(e.prompt=t.getElementById("prompt-input").value.trim(),e.productType=t.getElementById("prod-type").value,!e.prompt){t.getElementById("prompt-input").focus();return}e.loading=!0,r();try{let n=await fetch(`${c}/generate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:l,session_id:g,prompt:e.prompt,product_type:e.productType})}),a=await n.json();if(!n.ok){if(a.code==="LEAD_GATE_REQUIRED"){e.draftsRemaining=0,r();return}throw new Error(a.error||"Failed to generate")}e.currentImage=a.image_url,e.currentDesignId=a.design_id,e.draftsUsed=a.drafts_used,e.draftsRemaining=a.drafts_remaining}catch(n){alert(n.message)}finally{e.loading=!1,r()}})}}e.loading=!0,fetch(`${c}/tenants/validate/${l}`).then(i=>i.json()).then(i=>{e.loading=!1,i.valid?(e.isValid=!0,e.minimized=!0):e.isValid=!1,r()}).catch(()=>{e.loading=!1,e.isValid=!1,r()})})();})();
