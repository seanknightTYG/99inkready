const steps = [
  ...
  },
  {
    ...
    body: 'When you both love the concept, you go to your Rezify.io dashboard and hit Upscale. One click.',
  },
  {
    num: '04',
  ...
  return (
    <section className="how-section" id="how">
      <div className="max-w">
        ...
        <h2 className="section-title">Rezify.io Flips<br />The Script.</h2>
